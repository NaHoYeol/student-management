      ...
      <div className="mb-6 rounded-lg bg-white p-6 shadow-sm">
        {editing ? (
          <div className="space-y-3">
            ...
            <div>
              <label className="mb-1 block text-xs font-medium text-black">이름</label>
              <input
                value={editName}
          ...
          <>
            ...
            <div className="mt-4 grid grid-cols-3 gap-4">
              ...
              <div className="rounded-lg bg-gray-50 p-4 text-center">
                <p className="text-xs text-black">반</p>
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      ...
                      <p className="text-xs text-black">{pct}%</p>
                    </div>
                    <span
...
function EditField({
  ...
  return (
    <div>
      <label className="mb-1 block text-xs font-medium text-black">{label}</label>
      <select
        value={value}
        onChange={(e) => {
