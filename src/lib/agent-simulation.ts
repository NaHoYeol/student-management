...
export const ACCURACY_MATRIX: Record<number, Record<number, number>> = {
  1: { 1: 0.99, 2: 0.97, 3: 0.90, 4: 0.75, 5: 0.50 },
  2: { 1: 0.97, 2: 0.92, 3: 0.78, 4: 0.55, 5: 0.30 },
  3: { 1: 0.95, 2: 0.85, 3: 0.65, 4: 0.38, 5: 0.15 },
  4: { 1: 0.90, 2: 0.75, 3: 0.50, 4: 0.25, 5: 0.08 },
  5: { 1: 0.82, 2: 0.60, 3: 0.35, 4: 0.15, 5: 0.05 },
  6: { 1: 0.70, 2: 0.45, 3: 0.22, 4: 0.08, 5: 0.03 },
  7: { 1: 0.55, 2: 0.30, 3: 0.12, 4: 0.04, 5: 0.02 },
  8: { 1: 0.40, 2: 0.20, 3: 0.07, 4: 0.02, 5: 0.01 },
  9: { 1: 0.25, 2: 0.12, 3: 0.04, 4: 0.01, 5: 0.01 },
};
